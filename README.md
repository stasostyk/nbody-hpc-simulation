...
Using the generated data, a visualization tool is provided using OpenGL and GLFW to show the particles. Currently it is still in its minimal state, where the "Next Timestep" button loads in the next snapshot of the environment from the data generated by the solver. 

![UI Example](images/basic-ui.png)
